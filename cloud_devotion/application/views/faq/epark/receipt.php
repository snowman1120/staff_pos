...
<!--            <li class="nav_item"><div>失効</div><i class="fa fa-warning fa-2x"></i></li>-->
    ...
    <div id="receipt_left_panel" style="width: 350px; background-color: #d38751; padding: 8px 10px;display: none;" >
    ...
    <div class="content" style="    flex: 1 0 0%;">
                ...
                <div class="epark_content_row" style="display: flex;">
                    ...
                    <div style="width: 100%; display: flex;position:relative; background-color: #b5b5b5;">
                        ...
                        <?php if (!empty($staff['reserves']))
                            ...
                            <div data="<?php echo $reserve['id']; ?>" time_length="<?php echo  $reserve['width']; ?>" user_id="<?php echo $reserve['user_id']; ?>" class="reserve_item_main <?php
        ...
        <div id="sum_view">
            ...
            <div class="sum_view_row blue">
                <span>施術：45,550円/45,550円</span>
                &nbsp;&nbsp;&nbsp;&nbsp;
                <span> 物販：15,180円/15,180円</span>
                &nbsp;&nbsp;&nbsp;&nbsp;
                <span> 回数券販売：0円/0円</span>
            </div>
            <div class="sum_view_row">
                <span>現金：40,040円 </span>
                &nbsp;&nbsp;&nbsp;&nbsp;
                <span>クレジット：3,380円</span>
                &nbsp;&nbsp;&nbsp;&nbsp;
                <span>回数券利用：0円 </span>
                &nbsp;&nbsp;&nbsp;&nbsp;
                <span>商品券利用：0円</span>
                &nbsp;&nbsp;&nbsp;&nbsp;
                <span>電子マネー：17,310円 </span>
            </div>
        </div>
    </div>
</div>
