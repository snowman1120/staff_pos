                  ...
                  <table class="table table-hover">
                    ...
                    <tr>
                        ...
                        <td class="text-center">
                            ...
                            <a class="btn btn-sm btn-danger deleteStaff" href="#" data-userid="<?php echo $record->staff_id; ?>" title="削除"><i class="fa fa-trash"></i></a>
                        </td>
                    </tr>
                    <?php
                        }
