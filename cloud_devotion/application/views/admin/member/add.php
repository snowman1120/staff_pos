            ...
            <div class="col-md-8">
              <!-- general form elements -->
                ...
                <div class="box box-primary">
                    ...
                    <form role="form" id="addUser" action="<?php echo admin_url() ?>member/add" method="post" role="form">
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control required email" id="mail_address" value="<?php echo set_value('mail_address'); ?>" name="mail_address" maxlength="128">
                                    </div>
                                </div>
                            </div>
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control required " id="set_time" value="<?php echo set_value('set_time'); ?>" name="set_time" maxlength="128">
                                    </div>
                                </div>
                            </div>
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control required" id="set_amount" value="<?php echo set_value('set_amount'); ?>" name="set_amount" maxlength="128">
                                    </div>
                                </div>
                            </div>                                                        
                            <div class="row">
